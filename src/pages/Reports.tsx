...
import { User, Menu, LogOut, Home, Users, FileText } from "lucide-react";
      ...
      <div className={`bg-purple-900 text-white w-full md:w-64 flex-shrink-0 ${isMenuOpen ? "block" : "hidden md:block"}`}>
        ...
        <nav className="py-4">
          <ul>
            ...
            <li>
              <Link to="/reports" className="flex items-center px-4 py-3 bg-purple-800">
        ...
        <main className="flex-1 p-6">
          ...
          <Card className="shadow-sm">
            <CardContent className="p-6">
              <h3 className="text-lg font-medium mb-4">Sistem Pelaporan</h3>
              <p>Halaman ini berisi berbagai laporan akademik dan administratif.</p>
            </CardContent>
          </Card>
        </main>
      </div>
