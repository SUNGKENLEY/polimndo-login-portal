...
import { User, Menu, LogOut, Home, Users, Settings } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className={`bg-purple-900 text-white w-full md:w-64 flex-shrink-0 ${isMenuOpen ? "block" : "hidden md:block"}`}>
        ...
        <nav className="py-4">
          <ul>
            ...
            <li>
              <Link to="/system-settings" className="flex items-center px-4 py-3 bg-purple-800">
      ...
      <div className="flex-1 flex flex-col bg-gray-50">
        ...
        <main className="flex-1 p-6">
          <h1 className="text-2xl font-semibold mb-6">Pengaturan Sistem</h1>
          
          <Card className="shadow-sm">
            <CardContent className="p-6">
              <h3 className="text-lg font-medium mb-4">Konfigurasi Sistem</h3>
              <p>Halaman ini berisi fitur untuk mengelola pengaturan sistem portal akademik.</p>
            </CardContent>
          </Card>
        </main>
      </div>
